    ...
    return (
        <section className="home">
            <section className="container">
                ...
                <h2 className="section-title"> مدرسة المعالي الإبداعية الأهلية ترحب بكم بفخر وإعتزاز!</h2>
                <p className='subtitle'>
                    نحن في مدرسة المعالي نفتخر بتقديم بيئة تعليمية مميزة تهدف إلى تطوير شامل لطلابنا.
                    <br /><br />نرحب بأولياء الأمور الكرام والطلاب الأعزاء للإنضمام إلينا في رحلة تعليمية مثيرة ومليئة بالإثراء.
                    <br />
                    <br />
                    نعلن بكل فخر وسرور عن بدء عملية التسجيل للسنة الدراسية الجديدة 2024-2025. ففي مدرسة المعالي، نسعى جاهدين لتقديم تجربة تعليمية مميزة تتميز بالجودة والإهتمام الشخصي بكل طالب.
                    <br />
                    <br />
                    ندعوكم للإنضمام إلينا والاستفادة من برامجنا التعليمية المتميزة والفرص الرائعة التي نقدمها لطلابنا. لا تترددوا في التواصل معنا لمزيد من المعلومات حول عملية التسجيل وبرامجنا التعليمية المتنوعة.
                    <br />
                    <br />
                    نحن في انتظاركم لنبني مستقبلا مشرقا ونساهم سويًا في تحقيق أحلام أطفالنا ونجاحهم المستقبلي.
                    <br />
                    <br />
                </p>
                <button><Link to='/form'>التسجيل الأن <span><i className="fa-solid fa-sheet-plastic"></i></span></Link></button>
            </section>
